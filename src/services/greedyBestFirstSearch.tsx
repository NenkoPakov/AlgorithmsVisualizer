...
function* greedyBestFirstSearch(wallMatrix: boolean[][], startNode: Node, finishNode: Node) {
    ...
    // let iteration=0;
    // comeFrom[`${startNode.row}-${startNode.col}`] = { parent: undefined, value: heuristic(startNode, finishNode), iteration };
    ...
    //         comeFrom[`${neighbor.row}-${neighbor.col}`] = { parent: `${currentNode.node.row}-${currentNode.node.col}`, value: priority, iteration }
